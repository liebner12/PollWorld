...
import {
  boolToSex, numberToPlaceOfResidence,
  placeOfResidenceToNumber,
  profileDataJoiner, profileDataSeparator,
  sexToBool
...
const EdditPage = ({ navigation }) => {
  ...
  const setValues = (name, age, sex, job, hometown, height, weight, activity) =>{
            ...
            <Form
              ...
              fields={{
                ...
                hometown: {
                  ...
                  defaultValue: numberToPlaceOfResidence(details.place_of_residence),
                  fields: {
